...
import com.smartDine.services.TableService;
...
public class TableController {
     ...
     */
    @PostMapping
    public ResponseEntity<TableDTO> postTable(
        ...
        // Create the table
        Table createdTable = tableService.createTable(restaurantId, tableDTO, (Business) user);
        
        // Convert entity to DTO and return
        TableDTO responseDTO = TableDTO.fromEntity(createdTable);
     ...
     */
    @GetMapping
    public ResponseEntity<List<TableDTO>> getRestaurantTables(
            @PathVariable Long restaurantId,
            @AuthenticationPrincipal User user) {
        ...
        // Get the tables
        List<Table> tables = tableService.getTablesByRestaurant(restaurantId, (Business) user);
        
        // Convert entities to DTOs and return
        List<TableDTO> tableDTOs = TableDTO.fromEntity(tables);
